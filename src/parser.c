...
enum {
  ...
  sym_source_file = 18,
  sym__definition = 19,
  sym_package_declaration = 20,
  sym_component_declaration = 21,
...
static const uint16_t ts_parse_table[LARGE_STATE_COUNT][SYMBOL_COUNT] = {
  ...
  [1] = {
    ...
    [sym_component_declaration] = STATE(5),
...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [86] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_component_declaration, 4, .production_id = 3),
  ...
  [103] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_package_declaration, 2),
